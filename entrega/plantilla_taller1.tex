...
T5 & Estaciones sin departamento en el \emph{join} mal declarado & \marcador{~} \\
T5 & Estaciones sin departamento en el \emph{join} correcto    & \marcador{~} \\
\bottomrule
\end{tabularx}
\endgroup
...
\literal{c}{El \emph{join} espacial contra los departamentos, mal declarado y bien, con cuántas estaciones se quedan sin departamento en cada caso.}
\marcador{tu respuesta}
